package com.autumnia.openai.recipe.service;
...
public class RecipeService {
    ...
    private final String googleApiKey = "AIzaSyA77kGtAOxs3OS8yHItVhPN09DZUHbxR90";  // Google API 키를 입력하세요
    private final String googleCx = "44b29f4a8e6934f36"; // Google Custom Search Engine CX 키를 입력하세요
